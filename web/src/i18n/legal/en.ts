        ...
        blocks: [
          {
            ...
            items: [
              ...
              '*Account settings.* The default timer duration, the focus step, and ' +
                'whether domain rotation is on.',
            ],
          },
        ],
      },
        ...
        blocks: [
          ...
          },
          {
            ...
            text:
              ...
              'except the theme and the language — the two that belong to the screen ' +
